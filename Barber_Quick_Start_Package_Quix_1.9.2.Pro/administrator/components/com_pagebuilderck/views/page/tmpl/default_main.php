...
<form action="<?php echo JRoute::_('index.php?option=com_pagebuilderck&view=page' . $appendUrl . '&id=' . $this->item->id);?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form-validate">
		<?php if ($app->isSite() && $app->input->get('layout') != 'modal') { ?>
	...
	<div class="form-inline form-inline-header clearfix">
		<div>
	...
	<div class="maintab menustyles ckproperty" id="tab_options">
		...
		include_once(__DIR__ . '/default_options.php');
		?>
	</div>
...
<div id="workspaceparentck">
	...
	include_once(JPATH_ADMINISTRATOR . '/components/com_pagebuilderck/views/page/tmpl/default_toolbar.php');
	?>
	<div id="workspaceck" class="workspaceck<?php echo ($app->isSite() ? ' pagebuilderckfrontend' : '') ?>">
		<?php
...
<div id="pagebuilderckRestoreModalck" class="pagebuilderckRestoreModalck pagebuilderckModalck modal hide fade">
