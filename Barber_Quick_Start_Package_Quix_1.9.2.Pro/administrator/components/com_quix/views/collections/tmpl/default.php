				...
				<table class="table table-striped" id="pageList">
					...
					<tbody>
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="center">
								<div class="btn-group">
									<?php echo JHtml::_('jgrid.published', $item->state, $i, 'collections.', $canChange, 'cb'); ?>
									...
									JHtml::_('actionsdropdown.duplicate', 'cb' . $i, 'collections');
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'collections');
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_quix&task=collection.edit&type='.$item->type.'&id='.(int) $item->id); ?>">
