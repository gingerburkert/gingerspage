...
<div id="cktoolbarResponsive" class="clearfix ckinterface">
	...
	<span class="ckbutton-group">
		<span id="ckresponsive5button" class="ckbutton ckresponsivebutton" onclick="ckSwitchResponsive(5)" data-range="5"><span class="fa fa-tablet" style="font-size: 1.4em;vertical-align: bottom;transform:rotate(90deg);"></span> <?php echo JText::_('CK_TABLET') ?> / <small><?php echo JText::_('CK_LANDSCAPE') ?></small></span>
		<input id="ckresponsive5value" type="text" value="<?php echo $componentParams->get('responsive5value', '800') ?>" class="hasTooltip" data-default="" disabled="disabled" title="<?php echo JText::_('CK_SET_RESPONSIVE_VALUE_IN_OPTIONS') ?>" style="width:40px;"/>
	</span>
</div>
