...
<form action="<?php echo JRoute::_('index.php?option=com_quix&view=collection&type='.$this->item->type.'&layout=edit&id='.$this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="page-form" class="quix-layout-builder form-validate">
      ...
      <div class="row">
        <div class="col s12">
          <ul class="qx-appbar__navs tabs">
            <li class="tab active"><a href="#layout" data-toggle="tab"><?php echo JText::_('COM_QUIX_TITLE_PAGE_LAYOUT'); ?></a></li>
            <!-- <li><a href="#metadata" data-toggle="tab"><?php echo JText::_('COM_QUIX_FORM_LBL_PAGE_METADATA'); ?></a></li>
            <li><a href="#params" data-toggle="tab"><?php echo JText::_('COM_QUIX_FORM_LBL_PAGE_PARAMS'); ?></a></li> -->
          </ul>
