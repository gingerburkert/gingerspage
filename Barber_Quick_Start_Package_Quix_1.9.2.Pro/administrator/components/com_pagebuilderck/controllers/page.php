...
class PagebuilderckControllerPage extends JControllerForm {
	...
	public function save($key = null, $urlVar = null) {
		...
		if ($data === false) {
			...
			$this->setRedirect('index.php?option=com_pagebuilderck&view=page'.$layout.'&id=' . $id . $appendToUrl, false);
			return false;
		}
		...
		if ($return === false) {
			...
			$this->setRedirect('index.php?option=com_pagebuilderck&view=page&task=page.edit'.$layout.'&id=' . $id . $appendToUrl, false);
			return false;
		}
		...
		switch ($task)
		{
			case 'apply':
				...
				// Redirect back to the edit screen.
				$this->setRedirect('index.php?option=com_pagebuilderck&view=page&task=page.edit'.$layout.'&id=' . $return . $appendToUrl, false);
				break;
			default:
				...
				// Redirect to the list screen.
				$this->setRedirect('index.php?option=com_pagebuilderck&view=pages', false);
				break;
		}
	...
	function copy() {
		...
		$this->setRedirect('index.php?option=com_pagebuilderck', $msg, $type);
	}
