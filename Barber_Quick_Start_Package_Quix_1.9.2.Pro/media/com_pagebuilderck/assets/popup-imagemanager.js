 ...
 * Modification by Cédric Keiflin - ced1870 - http://www.joomlack.fr
 *
...
(function($) {
var ImageManagerCK = this.ImageManagerCK = {
	initialize: function()
	{
		...
		$(this.imageframe).on('load', function(){ ImageManagerCK.onloadimageview(); });

		// Setup folder up button
		this.upbutton = document.getElementById('upbutton');
		$(this.upbutton).off('click');
		$(this.upbutton).on('click', function(){ ImageManagerCK.upFolder(); });
	},
